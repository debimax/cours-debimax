...
%Dernière modification: 14 nov. 2018 14:10:07
...
%\Chapter{Utilisation de mes cours}
%
%\section{Pyzo}
%
%Ouvrez \textbf{Pyzo}. S'il vous le demande cliquez sur ``use this environement''.
%
%Pour la première utilisation de pyzo il faut faire quelques réglages. 
%Pour installer ou mettre à jour des modules python  on utilise \verb=pip=  ou \verb=conda=.  %Conda a l'avantage d'installer tout un ensemble de module python.
%
%Dans le shell python de \textbf{Pyzo} exécuter les séquences suivantes.
%
%
%\begin{list}{\ding{212}}{}
%\item Installer \textit{jupyter}.
%\begin{list}{$\bullet$}{}
%\item \verb=pip install --upgrade pip=
%\item \verb=conda install  jupyter=  \hspace{1cm}Cela prend du temps car python est mis à jour.
%\item  \verb=conda install  anaconda-client=
%\item \verb=conda install  -c conda-forge  jupyter_contrib_nbextensions=
%%\item pip  install  jupyter
%%\item pip  install  jupyter\string_nbextensions
%%\item pip  install  jupyter\string_contrib\string_nbextensions
%%\item contrib nbextension install --user
%%\item pip  install  jupyter\string_nbextensions\string_configurator 
%
%\item  \verb+notebook --no-browser  --NotebookApp.token=''+
%%\item \verb=notebook  --generate-config=
%%\item \verb=notebook password=  (mettre par exemple un pass vide)
%\end{list}
%
%\item  Télécharger un de mes cours : Ils se trouvent à l'adresse \url{https://github.com/debimax/cours-debimax}.\\
%Sinon utilisez un moteur de recherche avec les mots clefs: \textit{git debimax}
%
%
%\medskip
...
%
%
%%Ouvrez un navigateur à l'adresse \url{https://github.com/debimax/cours-debimax} et cliquez sur \textit{bases.ipynb} puis sur le bouton \href{https://github.com/debimax/cours-debimax/raw/master/bases.ipynb}{Raw}. Sauvegarder ce fichier où vous voulez.
%\item  Ouvrir un fichier  \textbf{\textit{.ipynb}}
%\begin{list}{-}{}
%\item Première méthode:  Dans votre gestionnaire de fichier cliquez sur le fichier\\
% \textbf{\textit{bases.ipynb}}  \ding{212} \textit{Sélectionner un programme dans la liste des programmes installés} \ding{212} Parcourir et indiquez alors le chemin  \verb+C://Programmes/Miniconda/Scripts/jupyter-notebook+
%
%%Sur certain ordinateurs le chemin est \verb+C:\Programme file32\jupyter\jupyter+
%
%
%\item Deuxième méthode:  Ouvrez pyzo.\\
% Dans la console pyzo tapez \textit{notebook}  (votre navigateur  s'ouvre)  \ding{212} Upload \ding{212} Indiquez le fichier bases.ipynb	\medskip
%
...
%
%%ipython a changé de nom récemment et s'appelle désormais  \textbf{jupyter-notebook}.
%
...
%\end{list}
%
%%Les cellules peuvent contenir du texte markdown,  html,  latex, python ruby etc \dots
%\bigskip
%
...
et afficher les valeurs.  \tabularnewline % de $f(-5)$ à $f(5)$.\tabularnewline
