...
%Dernière modification: 05 sept. 2017 21:35:25
...
\setlength\parindent{10pt}%noident
\begin{document}
...
Ouvrez \textbf{Pyzo}. Pour la première utilisation de pyzo il faut faire quelques réglages.\\
...
Ouvrez un navigateur à l'adresse \url{https://github.com/debimax/cours-debimax} et cliquez sur \textit{base.py} puis sur le bouton \href{https://github.com/debimax/cours-debimax/raw/master/bases.ipynb}{Raw}. Sauvegarder ce fichier où vous voulez.
\item  ouvrir un fichier
\begin{list}{-}{}
\item Première méthode:
\begin{list}{$\bullet$}{}
\item Dans la console pyzo tapez \textit{notebook}  (votre navigateur  s'ouvre)  \ding{212} new \ding{212} Indiquez le fichier base.ipy 
\end{list}
