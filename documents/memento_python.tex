...
%Dernière modification: 26 oct. 2014 09:10:30
...
\item \textcolor{red}{<<\texttt{i,n=symbols('i n')}>>} ou \textcolor{red}{<<\texttt{x=S('x')}>>} pour définir plusieurs variables.\item \textcolor{red}{<<\texttt{x=Symbol('x')}>>} ou \textcolor{red}{<<\texttt{x=S('x')}>>} définit x comme variable
...
\item \textcolor{red}{<<\texttt{evalf(sqrt(12))}>>} ou \textcolor{red}{<<\texttt{(sqrt(12)).evalf()}>>} pour evaluer $\sqrt[]{12}$.
\item \textcolor{red}{<<\texttt{expand(\textit{expr})}>>} ou  \textcolor{red}{<<\texttt{(\textit{expr}).expand()}>>} pour développer \textit{expr}.
\item \textcolor{red}{<<\texttt{factor(\textit{expr})}>>} ou \textcolor{red}{<<\texttt{(\textit{expr}).factor()}>>}  pour factoriser \textit{expr}.
\item \textcolor{red}{<<\texttt{(\textit{expr}).subs(x, 1)}>>} pour substituer x par 1 dans \textit{expr}.
